...
public class Communicator implements Runnable {
	...
	private RaceTracker trackedRace;
    ...
    public void run()
    {
        while (_keepGoing && datagramSocket!=null)
        {
            ...
            if (_processor!=null)
                _processor.process(this.trackedRace, message, senderAddress, senderPort);
        }
    }

	public RaceTracker getTrackedRace() {
		return trackedRace;
	}

	public void setTrackedRace(RaceTracker trackedRace) {
