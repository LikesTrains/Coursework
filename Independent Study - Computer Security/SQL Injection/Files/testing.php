...
<?php
   ...
   if($input_pwd!=''){
	...
	$input_pwd = sha1('easy'); 
	$sql = "UPDATE credential SET Password='$input_pwd' where name='Ryan'";
	#',email='$input_email',address='$input_address',Password='$input_pwd',PhoneNumber='$input_phonenumber' where ID=$input_id;";
   }else{
